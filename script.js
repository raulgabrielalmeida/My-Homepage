let shortcuts = JSON.parse(localStorage.getItem("myShortcuts")) || [null, null, null, null, null];
...
function renderShortcuts() {
  ...
  shortcuts.forEach((item, index) => {
    ...
    if (item) {
      img.src = item.icon || `https://www.google.com/s2/favicons?domain=${item.url}&sz=128`;
